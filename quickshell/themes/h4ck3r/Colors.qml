// Colors for the h4ck3r theme (Matrix/Hacker green-on-dark)
...
QtObject {
    // Static theme colors (h4ck3r - matrix hacker green)
    readonly property string _bg: "#0c1018"
    readonly property string _fg: "#6DDE00"
    readonly property string _black: "#1B2333"
    readonly property string _blackb: "#0c1018"
    readonly property string _red: "#6DDE00"
    readonly property string _green: "#00fa5c"
    readonly property string _yellow: "#76EA00"
    readonly property string _blue: "#578a29"
    readonly property string _magenta: "#9cf542"
    readonly property string _cyan: "#539e06"
    readonly property string _white: "#4A9801"
    ...
    readonly property string _accent_color: "#1B2333"
    ...
    // Semantic aliases
    readonly property string accent: ThemeManager.colorMode === "wallust" ? WallustColors.accent : _green
