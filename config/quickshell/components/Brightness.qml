    ...
    MouseArea {
        ...
        onClicked: {
            if (brightnessComp.rootBar) {
                brightnessComp.rootBar.volumePanelVisible = false;
                brightnessComp.rootBar.networkPanelVisible = false;
                brightnessComp.rootBar.bluetoothPanelVisible = false;
                brightnessComp.rootBar.settingsVisible = false;
                brightnessComp.rootBar.powerMenuVisible = false;
                brightnessComp.rootBar.themeSelectorVisible = false;
