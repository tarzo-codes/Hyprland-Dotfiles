...
QtObject {
    ...
    readonly property string _red: "#fb4934"
    readonly property string _green: "#b8bb26"
    readonly property string _yellow: "#fabd2f"
    readonly property string _blue: "#83a598"
    readonly property string _magenta: "#d3869b"
    readonly property string _cyan: "#8ec07c"
